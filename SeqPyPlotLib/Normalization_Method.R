...
normalized_matrix = estimateCommonDisp(normalized_matrix)

write.table(as.matrix(normalized_matrix$pseudo.counts), file=args[2], sep = '\t', col.names=FALSE)

output_path = paste(args[2], "_MDS_plot.png")
